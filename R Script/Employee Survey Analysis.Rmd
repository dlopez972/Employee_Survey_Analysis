...
EmpSurvData<-read.csv("https://raw.githubusercontent.com/dlopez972/Employee_Survey_Analysis/main/sample_employeesurvey_table.csv")
...
# looks like we have 
  ...
  ## emp ID
  ## emp mgr id
  ## three categories of the questions (turnover intention/job satisfaction/engagement)


# response rate by unit

EmpSurvData %>% 
  group_by(Unit) %>% 
  summarize("Response Rate" = n()) %>% 
  ungroup()
